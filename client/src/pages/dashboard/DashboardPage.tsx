...
function DocumentStats({list}: {list: { id: string; title: string; key: string; createdAt: string; }[]}) {
...
function DocumentList({list}: {list: { id: string; title: string; key: string; createdAt: string; }[]}) {
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 dark:bg-gray-900">
          <div className="container mx-auto px-6 py-8">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mt-8 mb-4">Documents</h2>
